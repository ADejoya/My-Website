...
<div class="container">
    ...
    if (isset($_POST["submit"])) {
        ...
        $block = $_POST["block"];
        $street = $_POST["street"];
        $phaseORsubdivision = $_POST["phaseORsubdivision"];
    ...
    empty($lot) || empty($block) || empty($street) || empty($phaseORsubdivision) || empty($barangay) || empty($country) || 
    empty($state) || empty($city) || empty($phone_country) || empty($phone_number)) {
    array_push($errors, "All fields are required");
        ...
        if (count($errors) > 0) {
            ...
            require_once "database.php";
            $sql = "INSERT INTO users (Last_Name, First_Name, email, lot, block, street, phaseORsubdivision, barangay, country, state, city, phone_country, phone_number, password) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            $stmt = mysqli_stmt_init($conn);
            $preparestmt = mysqli_stmt_prepare($stmt, $sql);
            if ($preparestmt){
                mysqli_stmt_bind_param($stmt, "ssssssssssssss", $Last_Name, $First_Name, $email, $lot, $block, $street, $phaseORsubdivision, $barangay, $country, $state, $city, $phone_country, $phone_number, $passwordHash);
    ...
    <form action="registration.php" method="post">
        ...
        <div class="form-group"> 
            <input type="text" class="form-control" name="phaseORsubdivision" placeholder="Phase/Subdivision: ">
        </div>
        ...
        <div class="form-group" >
            <select class="form-select" id="phone_country" name="phone_country" style="flex: 1;">
        ...
        <div class="form-group">
            <input type="tel" class="form-control" id="phone_number" name="phone_number" placeholder="Phone Number:" pattern="[0-9]*" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
        </div>
    ...
    <div><p>Already registered? <a href="homepage.php">Login Here</a></div>
</div>
